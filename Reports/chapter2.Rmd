...
Before proceeding with the classification, let us see how these 10 topics are related with the terms. For this, we consider top 10 words with highest magnitude of coefficients in $V$ matrix, corresponding to each topic.
...
mod.lda <- readRDS('../datasets/US_president_ML_parts/LDA_traindoc.Rds')
```
